...
#'
#' A dataset containing the response processes and binary response outcomes of 16920 respondents.
#'
...
#'   \item{responses}{Binary responses of 16920 respondent. The order of the respondents
